...
//
// 1. Создайте целочисленную переменную `bread` и задайте ей значение 25
// 2. Создайте дробную переменную `milk` типа Double и задайте ей значение 39.99
...
var bread: Int = 25
var milk: Double = 39.99
var sum: Double = Double (bread) + milk
